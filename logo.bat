...
REM
REM  Called rather than pasted into each script: three copies of a
REM  block whose every |, \ and ` has to survive cmd's parser is
REM  three chances to break one of them, and a broken one still
REM  prints - just wrong.
REM
